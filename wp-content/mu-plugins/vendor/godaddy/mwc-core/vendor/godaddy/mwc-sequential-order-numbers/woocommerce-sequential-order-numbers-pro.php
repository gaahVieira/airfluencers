 ...
 * @since 1.13.0
 */
class WC_Sequential_Order_Numbers_Pro_Loader {
	...
	/** @var WC_Sequential_Order_Numbers_Pro_Loader single instance of this class */
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot clone instances of %s.', get_class( $this ) ), '1.13.0' );
	}
	...
	public function __wakeup() {
		...
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot unserialize instances of %s.', get_class( $this ) ), '1.13.0' );
	}
	...
	public function init_plugin() {
		...
		if ( $this->plugins_compatible() ) {
			...
			require_once( plugin_dir_path( __FILE__ ) . 'class-wc-seq-order-number-pro.php' );
	 ...
	 * @since 1.13.0
	 *
	 * @return WC_Sequential_Order_Numbers_Pro_Loader
	 */
...
// fire it up!
WC_Sequential_Order_Numbers_Pro_Loader::instance();
