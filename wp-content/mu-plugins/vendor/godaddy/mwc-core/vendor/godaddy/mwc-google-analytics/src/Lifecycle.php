...
class Lifecycle extends Framework\Plugin\Lifecycle {
	...
	protected function upgrade_to_2_0_0(): void {
		...
		// revoke existing Google Authentication
		// delete auth tokens and account ID
		...
		// flush the Google account properties list
	 ...
	 * @since 3.0.0
	 */
	protected function upgrade_to_3_0_0(): void {
		global $wpdb;
